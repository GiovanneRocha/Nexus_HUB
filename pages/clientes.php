...
<div class="card-tabela clientes-tabela"><table class="tabela-dados"><thead><tr><th>EMPRESA</th><th>CNPJ</th><th>CONTATO</th><th>TELEFONE</th><th>E-MAIL</th><th>CAMINHÕES</th><th>AÇÕES</th></tr></thead><tbody><?php if (!$empresas): ?><tr><td colspan="7" class="clientes-vazio"><i class="bi bi-inbox"></i><br>Nenhuma empresa cadastrada.</td></tr><?php else: foreach ($empresas as $empresa): ?><tr><td><div class="empresa-celula"><span class="empresa-icone"><i class="bi bi-building"></i></span><strong><?= hClientes($empresa['nome']) ?></strong></div></td><td><?= hClientes($empresa['cnpj'] ?: '-') ?></td><td><?= hClientes($empresa['contato'] ?: '-') ?></td><td><?= hClientes($empresa['telefone'] ?: '-') ?></td><td><?= hClientes($empresa['email'] ?: '-') ?></td><td><?= (int) $empresa['total_caminhoes'] ?></td><td><div class="clientes-acoes"><a href="cadastros/cadastrar_empresa.php?edit=<?= (int) $empresa['id'] ?>" class="botao-pequeno btn-pequeno-acoes"><i class="bi bi-pencil"></i> Editar</a><a href="cadastros/cadastro_veiculo.php?empresa_id=<?= (int) $empresa['id'] ?>" class="botao-pequeno"><i class="bi bi-truck"></i> Frota</a></div></td></tr><?php endforeach; endif; ?></tbody></table></div>
