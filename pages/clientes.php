...
<style>
.clientes-toolbar{display:flex;justify-content:space-between;align-items:center;gap:14px;flex-wrap:wrap;margin:18px 0}.clientes-toolbar>.botao-acao{width:auto;flex:none;white-space:nowrap}.clientes-busca{display:flex;gap:8px;flex:1;max-width:620px}.clientes-busca input{width:100%;min-height:44px;height:44px;box-sizing:border-box;padding:10px 12px;border:1px solid var(--bordar);border-radius:8px;background:var(--surface);color:var(--texto-principal)}.clientes-busca input:focus{outline:none;border-color:var(--verde-esmeralda);box-shadow:0 0 0 3px rgba(16,185,129,.12)}.clientes-busca .botao-acao{min-height:44px;height:44px;box-sizing:border-box;padding:0 20px;display:inline-flex;align-items:center;justify-content:center;white-space:nowrap}.clientes-resumo{margin-bottom:12px;color:var(--texto-secundario);font-size:.85rem}.empresa-celula{display:flex;align-items:center;gap:10px}.empresa-icone{display:grid;place-items:center;width:34px;height:34px;border-radius:8px;background:rgba(16,185,129,.12);color:var(--verde-esmeralda);flex:none}.clientes-tabela{overflow-x:auto}.clientes-tabela table{min-width:760px}.clientes-acoes{display:flex;gap:7px;flex-wrap:wrap}.clientes-vazio{text-align:center;padding:36px;color:var(--texto-secundario)}@media(max-width:680px){.clientes-toolbar{align-items:stretch}.clientes-busca{max-width:none;flex-direction:column}.clientes-toolbar>.botao-acao{width:100%}}
</style>
</head>
