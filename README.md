...
├── novo_atendimento.html   # Formulário de novo atendimento
├── revisao.html            # Painel de revisão administrativa
├── historico.html          # Arquivo e consulta de histórico
├── clientes.html           # Base de dados de clientes
├── recuperar.html          # Recuperação de senha
├── signup.html             # Cadastro de novos usuários
